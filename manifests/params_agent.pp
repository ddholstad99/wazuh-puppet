...
class wazuh::params_agent {
  ...
  $agent_msi_download_location = 'https://packages.wazuh.com/5.x/windows'
      ...
      case $facts['os']['family'] {
        'Debian': {
          ...
          case $facts['os']['distro']['codename'] {
            ...
            /^(wheezy|stretch|buster|bullseye|bookworm|trixie|sid|precise|trusty|vivid|wily|xenial|bionic|focal|groovy|jammy|noble|resolute)$/: {
